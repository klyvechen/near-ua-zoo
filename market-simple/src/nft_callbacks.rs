...
impl NonFungibleTokenApprovalsReceiver for Contract {
    ...
    //     log!("signer id {}, contract id {}", signer_id, nft_contract_id);
    //     assert_ne!(
    //         nft_contract_id,
    //         signer_id,
    ...
    fn nft_on_approve(
        ...
        if market_type == "sale" {
            ...
            let mut by_nft_contract_id = self
                ...
                .unwrap_or_else(|| {
                    UnorderedSet::new(
                        StorageKey::ByNFTContractIdInner { account_id_hash: hash_account_id(&nft_contract_id), }
                        .try_to_vec()
                        .unwrap(),
                    )
                });
            ...
            self.sales.insert(
                ...
                &Sale {
                    ...
                    bids,
                    created_at: U64(env::block_timestamp()/1000000),
                    token_type: Some("".to_string().clone()),
                    is_auction: is_auction.unwrap_or(false),
                },
            );
        }
