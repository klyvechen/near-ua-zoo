use crate::*;
use near_sdk::{promise_result_as_success, PromiseResult, log};
...
impl Contract {
    ...
    pub fn resolve_purchase(
        ...
        match env::promise_result(0) {
            ...
            PromiseResult::Failed => panic!("{}", "oops! transfer from sender failed".to_string()),
            PromiseResult::Successful(result) => {log!("transfer succeed")},
        };
